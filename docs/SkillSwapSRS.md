...
Як користувач, я хочу відновити пароль, щоб відновити доступ до акаунта.

Як користувач, я хочу змінити пароль, щоб підвищити безпеку акаунта.

Як користувач, я хочу увійти через Google, щоб швидко авторизуватися.
...
Як користувач, я хочу переглянути навички користувача, щоб оцінити його компетентність.

Як користувач, я хочу переглянути інтереси користувача, щоб знайти спільні цілі.

Як користувач, я хочу переглянути відгуки користувача, щоб оцінити його надійність.

Як користувач, я хочу переглянути рейтинг користувача, щоб оцінити його репутацію.

Як користувач, я хочу завантажити або змінити аватар, щоб персоналізувати профіль.

Як користувач, я хочу видалити власний акаунт, щоб припинити використання платформи.

### Навички

Як користувач, я хочу додати навичку, щоб поділитися своїми вміннями.

Як користувач, я хочу переглянути власні навички, щоб керувати ними.
...
Як користувач, я хочу переглянути власні інтереси, щоб керувати ними.

Як користувач, я хочу редагувати інтерес, щоб оновлювати свої потреби.

Як користувач, я хочу видалити інтерес, щоб прибрати непотрібне.
...
Як користувач, я хочу фільтрувати користувачів за рівнем навички, щоб знайти відповідний рівень.
...
Як користувач, я хочу відхилити запит на обмін, щоб відмовитись від співпраці.
...
Як адміністратор, я хочу заблокувати або розблокувати користувача, щоб керувати доступом.
