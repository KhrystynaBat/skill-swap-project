...
Моделювання загроз було виконано з використанням OWASP Threat Dragon та методології STRIDE. Було змодельовано два основні флови проєкту: 
1. Доставка чат-повідомлень із використанням Angular SPA, SignalR Hub та PostgreSQL
2. Реєстрація користувача, вхід у систему та керування профілем, включно з автентифікацією, авторизацією та роботою з даними.

Для кожного флову визначено trust boundaries, data flows, процеси та сховища даних, ідентифіковано критичні загрози та описано відповідні стратегії їх пом’якшення. Повний звіт з моделювання загроз доступний за посиланням: [Threat Modeling Report](./skill-swap.pdf)
