...
describe('ProfileService', () => {
  ...
  it('loads my profile', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiUrl}/profile/me`);
  ...
  it('loads my skills', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiUrl}/profile/skills`);
    expect(req.request.method).toBe('GET');
  ...
  it('loads my interests', () => {
    ...
    const req = httpMock.expectOne(`${environment.apiUrl}/profile/interests`);
    expect(req.request.method).toBe('GET');
